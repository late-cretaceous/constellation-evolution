...
export const JOINT_STIFFNESS = 0.5;  // Significantly increased from 0.2 for stronger forces
export const JOINT_DAMPING = 0.98;   // Increased from 0.96 for even less damping
