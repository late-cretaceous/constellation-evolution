...
// Simulation settings
export const GENERATION_TIME = 60; // Duration of each generation in real seconds
...
export const JOINT_STIFFNESS = 2.0;  // Significantly increased for much stronger movement
